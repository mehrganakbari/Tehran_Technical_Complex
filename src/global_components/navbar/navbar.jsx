      ...
      <nav className="bg-white py-3 px-5 border-b border-slate-200 shadow">
          <div className="mx-auto container max-w-[1440px]">
            <div className="flex justify-between items-center">
              {/* logo */}
              <a href=""><img src={logo} alt="logoImage" className="w-28"/></a>
              {/* links */}
              <ul className="hidden sm:flex">
                  <a href=""><li className="py-4 px-5 text-slate-500 transition-all duration-300 hover:bg-slate-50 hover:shadow hover:border-b hover:border-slate-400">خانه</li></a>
                  <a href=""><li className="py-4 px-5 text-slate-500 transition-all duration-300 hover:bg-slate-50 hover:shadow hover:border-b hover:border-slate-400">محصولات</li></a>
                  <a href=""><li className="py-4 px-5 text-slate-500 transition-all duration-300 hover:bg-slate-50 hover:shadow hover:border-b hover:border-slate-400">درباره ما</li></a>
                  <a href=""><li className="py-4 px-5 text-slate-500 transition-all duration-300 hover:bg-slate-50 hover:shadow hover:border-b hover:border-slate-400">تماس با ما</li></a>
              </ul>
              {/* search Box -> desktop */}
              <div className="w-1/3 bg-Stone-100 px-3 py-2 rounded-lg border border-Gray-200 items-center hidden lg2:flex gap-2">
               <button className="searchSubmitBtn">
                 <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none">
                   <path stroke="#222F5D" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
               ...
               <input type="text" id="searchInput" placeholder="جستجوی  نام رشته، درس و..." 
