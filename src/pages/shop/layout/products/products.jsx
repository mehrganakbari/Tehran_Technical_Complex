      ...
      <div
        ...
        {data.data.map((item) => (
          <div className="relative w-72 border border-indigo-500 rounded-lg shadow-md cursor-pointer transition-all duration-300 hover:shadow-xl pb-12">
            ...
            <p className="font-bold px-2 py-3 text-center">{item.title}</p>
            <div className="px-2 flex gap-2 items-center my-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <div className="">
              <button className="bg-indigo-500 text-white rounded-lg mb-2 mx-[8px] py-2 w-[270px] absolute bottom-0">
                {item.price}
              </button>
            </div>
          </div>
